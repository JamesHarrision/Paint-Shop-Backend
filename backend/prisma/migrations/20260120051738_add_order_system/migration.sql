...
-- AddForeignKey
ALTER TABLE `analysis_histories` ADD CONSTRAINT `analysis_histories_userId_fkey` FOREIGN KEY (`userId`) REFERENCES `users`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
