    ...
    <header class="bg-white border-b-4 border-black sticky top-0 z-[10001] py-4">
      <div class="container mx-auto px-6 md:px-12 lg:px-24 flex justify-between items-center">
        ...
        <div class="flex items-center gap-4 md:gap-6">
          <!-- Cart Button -->
          <button onclick="window.navigate('cart')" class="relative w-10 h-10 md:w-12 md:h-12 border-4 border-black bg-white flex items-center justify-center shadow-[4px_4px_0px_#000] hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[6px_6px_0px_#000] transition-all group">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 md:h-6 md:w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" />
            </svg>
            <span id="cart-count" class="absolute -top-2 -right-2 bg-[#E2725B] text-white text-[10px] font-black px-1.5 py-0.5 border-2 border-black min-w-[20px] text-center">0</span>
          </button>
